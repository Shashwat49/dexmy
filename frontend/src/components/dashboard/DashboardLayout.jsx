...
const ADMIN_NAV = [
  { label: "Operations", items: [
    ...
    { path: "/dashboard/admin/student-packages", label: "Student Packages" },
    { path: "/dashboard/admin/support", label: "Support" },
  ]},
  { label: "Finance", items: [
