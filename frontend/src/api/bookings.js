...
export const getAvailableSlots = (subjectId) =>
  api
...
// Restore package credit transactionally when a package booking is cancelled.
export const cancelBooking = (bookingId) =>
  api.patch(`/bookings/package/${bookingId}/cancel`).then((r) => r.data);
