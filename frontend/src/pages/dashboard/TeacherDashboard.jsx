...
export default function TeacherDashboard() {
  ...
  const join = async (booking) => { try { const session = await getBookingSession(booking.id); navigate(`/classroom/${session.id}`); } catch (e) { setError(e.response?.data?.detail || "This classroom is not ready yet."); } };
