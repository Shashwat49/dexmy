...
export default function StudentDashboard() {
  ...
  const subjectEnglishRemaining = Math.max(0, 50 - englishCompleted);
  const subjectMathematicsRemaining = Math.max(0, 50 - mathematicsCompleted);
