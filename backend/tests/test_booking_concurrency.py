...
def test_admin_assignment_race_condition(client, seed_data, auth_headers, db_session):
    ...
    def assign_teacher(teacher_id):
      return client.post(
    f"/api/v1/admin/bookings/{booking.id}/assign-teacher",
    ...
    print("ASSIGNMENT RESPONSE STATUSES:", [r.status_code for r in responses])
    print("ASSIGNMENT RESPONSE BODIES:", [r.text for r in responses])
